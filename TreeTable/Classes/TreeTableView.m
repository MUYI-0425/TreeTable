...
-(instancetype)initWithFrame:(CGRect)frame withData : (NSArray *)data{
    ...
    if (self) {
        ...
        [self registerNib:[UINib nibWithNibName:@"TreeTableViewCell" bundle:currentBundle] forCellReuseIdentifier:@"node_cell_id"];
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        cell = [[[NSBundle bundleForClass:[self class]] loadNibNamed:@"TreeTableViewCell" owner:self options:nil] lastObject];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //是否到了最深处
    if (![self NodeHasChildrenNode:parentNode]) {
